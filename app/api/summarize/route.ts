...
export async function POST(req: Request) {
  try {
    ...
    const { messages, wordCount, tone, citation } = body;
      ...
      messages: [
        {
          ...
          content: `
                ...
                Summazrie the below text upto ${wordCount} words count and tone of summarization should be ${tone} and citation styles should be ${citation}
                `,
        },
